...
//        20
        this.Pregunta12.setText(arr.get(nivel).getpregunta());
    ...
    private void initComponents() {
        ...
        Pregunta12.setFont(new java.awt.Font("Times New Roman", 1, 25)); // NOI18N
        Pregunta12.setForeground(new java.awt.Color(255, 255, 255));
        Pregunta12.setText("¿Cuál es la religión mayoritaria en en China?  ");

        boton1.setBackground(new java.awt.Color(51, 102, 255));
        boton1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        boton1.setForeground(new java.awt.Color(255, 255, 255));
        boton1.setText("Taoísmo");
...
if(arr.get(lugar).getresp()==1){
            ...
            lugar++;
            this.Pregunta12.setText(arr.get(lugar).getpregunta());
