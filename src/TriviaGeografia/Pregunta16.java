 ...
 * @author malol
 */
public class Pregunta16 extends javax.swing.JFrame {
...
//        20
        this.Pregunta16.setText(arr.get(nivel).getpregunta());
    ...
    private void initComponents() {
        ...
        Pregunta16.setFont(new java.awt.Font("Times New Roman", 1, 25)); // NOI18N
        Pregunta16.setForeground(new java.awt.Color(255, 255, 255));
        Pregunta16.setText("¿En que continente está la India?");

        boton1.setBackground(new java.awt.Color(51, 102, 255));
        boton1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        boton1.setForeground(new java.awt.Color(255, 255, 255));
        boton1.setText("Oceanía");
...
if(arr.get(lugar).getresp()==1){
            ...
            lugar++;
            this.Pregunta16.setText(arr.get(lugar).getpregunta());
...
if(arr.get(lugar).getresp()==3){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pregunta16.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pregunta16().setVisible(true);
            }
        });
    }
