...
//        20
        this.Pregunta10.setText(arr.get(nivel).getpregunta());
    ...
    private void initComponents() {
        ...
        Pregunta10.setFont(new java.awt.Font("Times New Roman", 1, 25)); // NOI18N
        Pregunta10.setForeground(new java.awt.Color(255, 255, 255));
        Pregunta10.setText("¿A que país pertenece la isla Mujeres?  ");

        boton1.setBackground(new java.awt.Color(51, 102, 255));
        boton1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        boton1.setForeground(new java.awt.Color(255, 255, 255));
        boton1.setText("México");
...
if(arr.get(lugar).getresp()==1){
            ...
            lugar++;
            this.Pregunta10.setText(arr.get(lugar).getpregunta());
...
if(arr.get(lugar).getresp()==2){
            ...
            boton2.setText(arr.get(lugar).getr2());
            boton3.setText(arr.get(lugar).getr3());
        }    // TODO add your handling code here:////// T      // TODO add your ha       // TODO add your handling code here:
