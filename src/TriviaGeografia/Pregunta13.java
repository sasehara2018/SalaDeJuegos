...
//        20
        this.Pregunta13.setText(arr.get(nivel).getpregunta());
    ...
    private void initComponents() {
        ...
        Pregunta13.setFont(new java.awt.Font("Times New Roman", 1, 25)); // NOI18N
        Pregunta13.setForeground(new java.awt.Color(255, 255, 255));
        Pregunta13.setText("¿A que país pertenece la isla de Pascua? ");

        boton1.setBackground(new java.awt.Color(51, 102, 255));
        boton1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        boton1.setForeground(new java.awt.Color(255, 255, 255));
        boton1.setText("Chile");
...
if(arr.get(lugar).getresp()==1){
            ...
            lugar++;
            this.Pregunta13.setText(arr.get(lugar).getpregunta());
...
if(arr.get(lugar).getresp()==3){
            ...
            boton2.setText(arr.get(lugar).getr2());
            boton3.setText(arr.get(lugar).getr3());
        }// TODO add your handling code here:   // TODO      // TODO add y      // TODO add your handling code here:
