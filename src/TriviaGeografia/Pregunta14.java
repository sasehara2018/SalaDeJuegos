...
//        20
        this.Pregunta14.setText(arr.get(nivel).getpregunta());
    ...
    private void initComponents() {
        ...
        Pregunta14.setFont(new java.awt.Font("Times New Roman", 1, 25)); // NOI18N
        Pregunta14.setForeground(new java.awt.Color(255, 255, 255));
        Pregunta14.setText("¿En qué país de África el español es el idioma oficial? ");

        boton1.setBackground(new java.awt.Color(51, 102, 255));
        boton1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        boton1.setForeground(new java.awt.Color(255, 255, 255));
        boton1.setText("Gabón i ");
...
if(arr.get(lugar).getresp()==1){
            ...
            lugar++;
            this.Pregunta14.setText(arr.get(lugar).getpregunta());
