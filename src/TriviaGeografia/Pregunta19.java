...
//        20
        this.Pregunta19.setText(arr.get(nivel).getpregunta());
    ...
    private void initComponents() {
        ...
        Pregunta19.setFont(new java.awt.Font("Times New Roman", 1, 25)); // NOI18N
        Pregunta19.setForeground(new java.awt.Color(255, 255, 255));
        Pregunta19.setText("¿Cuál de estos paises no está en una isla?  ");

        boton1.setBackground(new java.awt.Color(51, 102, 255));
        boton1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        boton1.setForeground(new java.awt.Color(255, 255, 255));
        boton1.setText("Madagascar ");
...
if(arr.get(lugar).getresp()==1){
            ...
            lugar++;
            this.Pregunta19.setText(arr.get(lugar).getpregunta());
...
if(arr.get(lugar).getresp()==3){
            ...
            boton2.setText(arr.get(lugar).getr2());
            boton3.setText(arr.get(lugar).getr3());
        }// TODO add your handling code here:   // TODO      //  /     // T       // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pregunta19.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pregunta19().setVisible(true);
            }
        });
    }
